...
locations = [
{
    ...
    level: "novice",
    length: "2.1 km",
    main_picture: File.new(File.join(Rails.root, "public", "seedimages", "LAWinter_2016.jpg")),
}, {
    state: "CA",
    ...
    level: "intermediate",
    length: "3.4 km",
    main_picture: File.new(File.join(Rails.root, "public", "seedimages", "SF-GG.jpg")),
}, {
    state: "OR",
    ...
    level: "expert",
    length: "10.5 km",
    main_picture: File.new(File.join(Rails.root, "public", "seedimages", "Bend_Oregon.jpg")),
}]
...
bc = Location.create(state: "CA", location_name: "Beachwood Canyon", location_address: "2795 Woodshire Dr, Los Angeles, CA 90068", nearest_city: "Los Angeles, CA", google_map_link: "https://goo.gl/maps/3foW715qkF52", level: "intermediate", length: "3.4 km", main_picture: File.new(File.join(Rails.root, "public", "seedimages", "beechwood.jpg")))
...
btn = Location.create(state: "CA", location_name: "Bridge to Nowhere", location_address: "Camp Bonita Road, San Gabriel Mountains National Monument, Azusa, CA 91702", nearest_city: "Los Angeles, CA", google_map_link: "https://goo.gl/maps/pTKpYJdCSzK2", level: "intermediate", length: "10 miles out and back", main_picture: File.new(File.join(Rails.root, "public", "seedimages", "Bridge_to_Nowhere.jpg")))
